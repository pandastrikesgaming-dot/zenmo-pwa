...
export function PdfDocumentViewer({
  ...
  useEffect(() => {
    ...
    async function getPdfJsFromCdn(): Promise<PdfJsModule> {
    ...
    async function loadPdf() {
      try {
        ...
        // Use CDN robustly to bypass Metro bundling crashes and ensure it works on mobile
        const pdfjs = await getPdfJsFromCdn();
